...
// TestParse checks the OpenPhishFeed.Parse() method, ensuring it processes lines properly.
func TestParse(t *testing.T) {
	...
	provider := NewOpenPhishFeedProvider(&config.GetConfig().Collector, cc, repository)
